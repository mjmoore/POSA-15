...
class RequestHandler extends Handler {
    ...
    // Store a WeakReference to the Service to enable garbag collection.
    ...
    public void handleMessage(Message message) {
        ...
        final RequestMessage requestMessage = RequestMessage.makeRequestMessage(message);
        ...
        Log.d(TAG, "dirpathname " + directoryPathname );
        ...
        final Runnable downloadImageAndReply = new Runnable() {
                ...
                public void run() {
                    ...
                    // DONE -- you fill in here.
                    Uri image = Utils.downloadImage(mService.get(), url, directoryPathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // DONE -- you fill in here
                    sendPath(replyMessenger, image, url, requestCode);
                }
            };
     ...
     */
    public void sendPath(Messenger messenger, Uri pathToImageFile, Uri url, int requestCode) {
        ...
        Log.d(TAG, "sending " + pathToImageFile + " back to the MainActivity");
