...
public class ImageOps {
     ...
     */
    public ImageOps(MainActivity activity, boolean useBoundService) {
        if (useBoundService)
   ...
   /**
     ...
     */
    public void doResult(int requestCode, int resultCode, Bundle data) {
        mImageOpsImpl.doResult(requestCode, resultCode, data);
    }
